...
| F03 | Claude / Cursor / Kiro 监听 | [Claude](../core/claude-reader.mjs)、[Cursor](../core/cursor-reader.mjs)、[Kiro](../core/kiro-reader.mjs) | 只支持已知格式；Cursor/Kiro 实机范围见 [专题说明](multi-provider-monitoring.md)；对应 reader 测试 |
...
| F08 | 任务跳转、项目、终端 | [主进程](../electron/main.mjs)、[目标校验](../core/task-jump.mjs)、[桥接](../electron/preload.cjs) | 点击才定位，不执行命令；包装进程不能冒充原生会话；[跳转测试](../tests/task-jump.test.mjs) |
